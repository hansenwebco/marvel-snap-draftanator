<script>
	...
	import GridPicker from '../components/grid/grid-picker.svelte';

</script>

<svelte:head>
	<title>Marvel Snap! Draftanator - Grid Draft</title>
    <meta name="title" content="Marvel Snap! Draftanator - Grid Draft">
